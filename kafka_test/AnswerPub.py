...
# 基本參數
KAFKA_BROKER_URL = '3.136.22.48:9092'   # 設定要連接的Kafka群
WORKSHOP_ID = 'tfb103'                       # 修改成你/妳的班級編號
STUDENT_ID = int('17')                       # 修改成你/妳的名稱
...
if __name__ == '__main__':
    ...
    try:
        ...
        producer.produce(topicName, '1', STUDENT_ID+'|07')  # 第 7題
        ...
        producer.produce(topicName, '5', STUDENT_ID+'|14')  # 第14題
        producer.produce(topicName, '5', STUDENT_ID+'|15')  # 第15題

        producer.produce(topicName, '5', STUDENT_ID+'|16')  # 第16題
